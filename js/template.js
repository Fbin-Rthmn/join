  ...
  <div id="privacy-render" class="task-info-section d-none-summary">
            ...
            <div id="legale-notice-render" class="task-info-section d-none-summary">
              <span id="legal-notice-page" class="virtualClass help-page">
                ...
                <div class="help-text">
                  <ul class="list-email">
                    <li class="list-notice">
                      <a class="mail-links" href="#">Rothmann Fabian</a>
                    </li>
                    <li class="list-notice">
                      <a class="mail-links" href="mailto:rf986@da.de">rf986@da.de</a>
                    </li>
                    <li class="list-notice">
                      <a class="mail-links" href="#">Rosenstaße 1, Munich</a>
                    </li>
                  </ul>
                </div>
                <div>
                ...
                <div class="date-legal-notice">Date: March 24, 2024</div>
              </span>
            </div>
